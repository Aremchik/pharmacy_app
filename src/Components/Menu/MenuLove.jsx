    ...
    return(
        <View style={styles.container}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('Love')}>
                <Image source={require('../../UI/img/loveGreen.png')} style={{width: 70,height: 55,marginTop: 13,}}/>
            </TouchableOpacity>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('MainProfile')}>
                <Image source={require('../../UI/img/profileGreen.png')} style={{width: 54,height: 55,marginTop: 15,}}/>
            </TouchableOpacity>
        </View>
    )
}
